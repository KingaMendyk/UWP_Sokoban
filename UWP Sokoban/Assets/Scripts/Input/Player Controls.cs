    ...
    ""maps"": [
        {
            ...
            ""actions"": [
                {
                    ""name"": ""Movement"",
                    ""type"": ""Value"",
                    ""id"": ""ec5a02dd-1d8a-4949-9dfa-00a7b5284d50"",
            ...
            ""bindings"": [
                {
                    ""name"": ""WASD"",
                    ""id"": ""f393b440-b653-4cb5-9c01-f440f97e071a"",
                    ""path"": ""2DVector"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": ""up"",
                    ""id"": ""89a74ccb-44fe-45f8-b158-cfd04c4067d4"",
                    ""path"": ""<Keyboard>/w"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": ""down"",
                    ""id"": ""b189ecd3-3021-49c1-b2f6-f0a56bc42e7d"",
                    ""path"": ""<Keyboard>/s"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": ""left"",
                    ""id"": ""3d0d5fab-4e78-49e1-a000-bd1aceb361ee"",
                    ""path"": ""<Keyboard>/a"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": ""right"",
                    ""id"": ""04345f11-87cf-4658-ae21-1b782ee5334b"",
                    ""path"": ""<Keyboard>/d"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": ""Arrow Keys"",
                    ""id"": ""fe407088-ddfc-4b13-97ec-7421f36c51a3"",
                    ""path"": ""2DVector"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": ""up"",
                    ""id"": ""10cc5aff-3f38-4fd4-9092-98f52983fffc"",
                ...
                {
                    ""name"": ""down"",
                    ""id"": ""f0cf745f-6e5f-4c53-a35e-aae488e1733f"",
                ...
                {
                    ""name"": ""left"",
                    ""id"": ""6f18c37c-d037-4442-89e9-09584b19a77a"",
                ...
                {
                    ""name"": ""right"",
                    ""id"": ""9ec6e0dc-ba2c-412e-a474-2dced43fe789"",
